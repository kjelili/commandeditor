        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="/" onClick={(e) => { e.preventDefault(); setSelectedTool(null); window.scrollTo({ top: 0, behavior: 'smooth' }) }}
              ...
              <defs><linearGradient id="ceGradNav" x1="0" y1="0" x2="0" y2="40" gradientUnits="userSpaceOnUse"><stop stopColor="#131f37"/><stop offset="1" stopColor="#0a1120"/></linearGradient></defs>
              <rect x="1.5" y="1.5" width="37" height="37" rx="11" fill="url(#ceGradNav)" stroke="#3f5fb0" strokeOpacity="0.85" strokeWidth="1.4"/>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-0 w-full">
          <div className="max-w-2xl lg:max-w-3xl">
            ...
            <p className="text-lg md:text-xl mb-10 max-w-xl animate-fade-up"
              ...
              113 tools in one private toolkit — now with an on-device AI assistant, cryptographic
            ...
            <div className="flex flex-wrap gap-10 mt-16 animate-fade-up" style={{ animationDelay: '0.32s' }}>
              {[{ val: '113', label: 'PDF tools' }, { val: '60+', label: 'Voice commands' }, { val: '0', label: 'Server uploads' }, { val: '∞', label: 'File size limit' }].map(s => (
                <div key={s.label}>
      ...
      <section className="py-20 border-t" style={{ borderColor: 'var(--border)', background: 'var(--card-bg)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl md:text-5xl mb-4">113 tools. Zero cost.</h2>
