...
export const metadata: Metadata = {
  ...
  description:
    'CommandEditor is a private, browser-based PDF & document toolkit with 85+ tools — including an on-device AI assistant, cryptographic e-signatures, document fingerprinting, redaction, OCR, and 50+ hands-free voice commands. Everything runs in your browser; your files never leave your device.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      '85+ PDF tools, an on-device AI assistant, cryptographic e-signatures, and 50+ hands-free voice commands — zero uploads. Every operation runs in your browser; your documents never leave your device.',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'A private PDF toolkit with 85+ tools — AI assistant, e-signatures, redaction, and 50+ voice commands, all in your browser. No uploads, no sign-up, free forever.',
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                'Private PDF and document toolkit. 85+ tools — including an on-device AI assistant and cryptographic e-signatures — that run entirely in your browser. Your files never leave your device.',
