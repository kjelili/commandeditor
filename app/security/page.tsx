...
export default function SecurityPage() {
  return (
    <LegalPage title="Security & Compliance" updated="26 August 2026"
      ...
      <p>No advertising, no cross-site tracking, no account requirement, no server-side copies of your files, and no transmission of document content to any third party (including for AI, which runs locally). For product insight we use privacy-friendly, cookieless, aggregate web analytics that count only anonymous page views and app installs — never your files, never personal data, set no cookies, and nothing fires during document processing (you can confirm this yourself with the Proof of No Upload tool).</p>
